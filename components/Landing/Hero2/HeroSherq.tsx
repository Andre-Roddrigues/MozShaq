  ...
  return (
    <div className="relative min-h-screen bg-slate-800 dark:bg-slate-900 overflow-hidden">
      ...
      <div className="relative z-10">
        ...
        <motion.div 
          className="relative z-10 -mt-28 pb-16"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
            ...
            >
              {[...courses, ...courses].map((course, index) => (
                <div key={index} className="flex items-center gap-8 shrink-0">
                  ...
                  {/* <Star className="text-brand-main shrink-0" size={20} /> */}
                </div>
              ))}
            </motion.div>
          </div>
        ...
        >
          <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6 px-6">
            ...
            >
              ...
              >
                <BookOpen className="text-white dark:text-white" size={22} />
              </motion.div>
            ...
            >
              ...
              >
                <Award className="text-white dark:text-white" size={22} />
              </motion.div>
              <h3 className="text-sm font-bold text-slate-800 dark:text-white mb-2">
