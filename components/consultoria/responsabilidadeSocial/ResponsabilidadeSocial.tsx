        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6">
              Responsabilidade <span className="text-blue-200">Social</span>
            </h1>
                  ...
                  >
                    <div className="flex items-start gap-4 mb-4">
                      <div className="w-12 h-12 bg-blue-100 dark:bg-blue-900 rounded-lg flex items-center justify-center flex-shrink-0">
                        {index === 0 && <Handshake className="w-6 h-6 text-blue-600 dark:text-blue-400" />}
                        {index === 1 && <Users className="w-6 h-6 text-blue-600 dark:text-blue-400" />}
                        {index === 2 && <Target className="w-6 h-6 text-blue-600 dark:text-blue-400" />}
                        {index === 3 && <Globe className="w-6 h-6 text-blue-600 dark:text-blue-400" />}
                      </div>
                      <div>
